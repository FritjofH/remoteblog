...
ActiveRecord::Schema.define(version: 2021_07_29_101856) do
  ...
  create_table "about_list_texts", force: :cascade do |t|
    ...
    t.index ["about_id"], name: "index_about_list_texts_on_about_id"
  end
  ...
  add_foreign_key "about_list_texts", "abouts"
